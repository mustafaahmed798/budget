...
var budgetController = (function () {
  ...
  Expense.prototype.calcPercentage = function (totalIncome) {
    // totalIncome is passed as data.total.inc
    if (totalIncome > 0) {
  ...
  return {
    ...
    deleteItem: function (type, id) {
      ...
      // retrieve index of element we want to remove
...
var UIController = (function () {
  ...
  return {
    ...
    clearFields: function () {
      ...
      // transform list of DOM selectors into array and store in a variable
      fieldsArr = Array.prototype.slice.call(fields);

      // loop over array and clear fields value
      fieldsArr.forEach(function (current, index, array) {
        current.value = "";
      });

      // sets focus back to description field
      fieldsArr[0].focus();
    },
